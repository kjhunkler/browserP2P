...
const APP_SHELL = [
  "./",
  "./index.html",
  "./css/style.css?v=2.6.2",
  "./js/app.js?v=2.6.2",
  "./js/games/digger.js?v=2.6.2",
  "./js/games/air-hockey.js?v=2.6.2",
  "./js/games/paint-panic.js?v=2.6.2",
  "./js/games/tower.js?v=2.6.2",
  "./js/games/snow-brawl.js?v=2.6.2",
  "./js/games/gentle-rain.js?v=2.6.2",
  "./js/peer-net.js?v=2.6.2",
